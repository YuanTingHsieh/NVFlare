...
class NVDXFUtils:
    def __init__(self, data_exchange_path: str, *, heartbeat_period: float = 0.5, heartbeat_timeout: float = 10000):
    ...
    def remove(self, name: str):
        ...
        os.remove(os.path.join(endpoint_path, f"REQ.H5FileAccessor.{name}"))

    def get_data(self, name: str):
        endpoint_path = os.path.join(self.pipe_path, "y")
        input_file = os.path.join(endpoint_path, f"REQ.H5FileAccessor.{name}")
    ...
    def put_data(self, name, output_weights):
        ...
        output_file = os.path.join(endpoint_path, f"REQ.H5FileAccessor.{name}")
